...
urlpatterns = [
    ...
    path('private/<str:user_id>/',                views.get_or_create_private,     name='conv-private'),
    # Groupe trajet (Uber-style)
    path('trajet/<int:trajet_id>/groupe/',         views.get_or_create_groupe_trajet, name='conv-groupe-trajet'),
]
